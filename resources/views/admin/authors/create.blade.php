    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-lg-offset-3">
                ...
                <form action="{{Config::get('app.url')}}authors/create" enctype="multipart/form-data"
                      class="bs-example bs-example-form" method="POST">
                    <input type="hidden" name="_method" value="POST">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">

                    <div class="form-group">
                        <input type="text" name="name" required="yes" class="form-control" placeholder="Author Name"
                               aria-describedby="sizing-addon2">
                    </div>
                    <div class="form-group">
                        <input type="text" name="email" required="yes" class="form-control" placeholder="Author Email"
                               aria-describedby="sizing-addon2">
                    </div>
                    <div class="form-group">
